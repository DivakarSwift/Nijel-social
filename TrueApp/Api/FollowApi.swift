...
class FollowApi {
    ...
    func followAction(withUser id : String) {
        ...
        print("Adding current user to user list")
        REF_FOLLOWING.child(Auth.auth().currentUser!.uid).child(id).setValue(true) //i dont thin this is working
        print("Adding following to current user")
    }
